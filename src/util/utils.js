...
export const REGEX = {
    ...
    plot: /^([a-zA-Z0-9,."'()!?-\s]|[^\x00-\x7F]){1,800}$/,
    imdb: /^[t]{2}[0-9]{7}$/,
    rating: /^[0-9]{1}.[0-9]{1}$/,
    douban: /^[0-9]{1,10}$/,
    mtime: /^[0-9]{1,10}$/,
...
export const loadComp = () => {
    return <div className="load-comp">Loading components...</div>
}
